            ...
            <table>
                ...
                <?php foreach ($ingresosDelDia as $ingreso): ?>
                    <tr>
                        ...
                        <td class="acciones">
                            <a href="?controller=ingresos&action=editar&id=<?php echo $ingreso['id']; ?>" class="btn btn-edit">Editar</a>
                            <a href="?controller=ingresos&action=eliminar&id=<?php echo $ingreso['id']; ?>" class="btn btn-delete" onclick="return confirm('¿Está seguro de que desea eliminar este registro?')">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
        <?php else: ?>
            <p class="no-results">No hay ingresos registrados para hoy.</p>
        <?php endif; ?>
